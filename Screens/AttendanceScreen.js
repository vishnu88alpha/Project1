        ...
        <View style={styles.modalContent}>
          ...
          {!selectedSubject ? (
            ...
            <>
              ...
              <Text>{`Attended: ${selectedSubject?.attendance}`}</Text>
              <Text>{`Not Attended: ${selectedSubject ? selectedSubject.totalClasses - selectedSubject.attendance : 0}`}</Text>
              <Text>{`Total: ${selectedSubject?.totalClasses}`}</Text>
            </>
          )}
